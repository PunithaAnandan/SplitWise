...
<div id="content" align="center">
    ...
    <form>
        <table>
            ...
            <tr><td>Reset password</td><td><input type="password" name="password" /></td></tr>
            <tr><td><input type="submit" name="" value="Back to Home" /></td><td><input type="submit" name="" value="Done" /></td></tr>
        </table>
